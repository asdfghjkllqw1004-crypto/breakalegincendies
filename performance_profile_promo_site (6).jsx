...
const actors = [
  {
    ...
    role: "배우",
    character: "의사",
    quote: "헛걸음 하셨네 여기도 애들은 없어요.",
    color: "from-stone-900 to-red-950",
    image: "/images/kim-seon-young.jpg",
    fallbackImage: "/images/김선영(1).jpg",
  ...
  },
  {
    ...
    role: "배우",
    character: "샴세딘",
    quote: "별들의 침묵이 니안에 있구나",
    color: "from-zinc-900 to-orange-950",
    image: "/images/kim-young-man.jpg",
    fallbackImage: "/images/김영만.jpg",
    imagePosition: "center 18%",
  },
  {
    name: "김종현",
    role: "배우",
    character: "니하드 / 랄프 / 민병대",
    quote: "처음이 어렵지 금방 쉬워져",
    color: "from-neutral-900 to-red-900",
    image: "/images/kim-jong-hyun.jpg",
    fallbackImage: "/images/김종현.jpg",
    imagePosition: "center 18%",
  },
  {
    name: "박다현",
    role: "배우",
    character: "어린 나왈",
    quote: "무슨 일이 있어도 난 널 언제나 사랑할 거야.",
    color: "from-stone-800 to-amber-950",
    image: "/images/park-da-hyun.jpg",
    fallbackImage: "/images/박다현.jpg",
    imagePosition: "center 18%",
  },
  {
    name: "박서연",
    role: "배우",
    character: "사우다",
    quote: "네가 슬플 땐 노래를 불러줄게.",
    color: "from-zinc-950 to-rose-950",
    image: "/images/park-seo-yeon.png",
    fallbackImage: "/images/박서연.png",
    imagePosition: "center 18%",
  },
  {
    name: "박지원",
  ...
  },
  {
    ...
    role: "배우",
    character: "노년 나왈",
    quote: "함께 있는 것보다 아름다운 일은 없어.",
    color: "from-stone-900 to-orange-900",
    image: "/images/eom-ji-won.jpg",
    fallbackImage: "/images/엄지원.jpg",
    imagePosition: "center 18%",
  },
  {
    name: "이상엽",
    role: "배우",
    character: "시몽",
    quote: "하나 더하기 하나가, 하나가 될수도있어?",
    color: "from-zinc-900 to-red-900",
    image: "/images/lee-sang-yeop.jpg",
    fallbackImage: "/images/이상엽.jpg",
    imagePosition: "center 18%",
  },
  {
    name: "이수민",
    role: "배우",
    character: "앙투완",
    quote: "아직도 당신 어머님 목소리가 귀에 울리는 것 같아요.",
    color: "from-neutral-900 to-amber-950",
    image: "/images/lee-su-min.jpg",
    fallbackImage: "/images/이수민(1).jpg",
    imagePosition: "center 18%",
  },
  {
    name: "인수민",
    role: "배우",
    character: "알퐁스 르벨 / 엘람",
    quote: "제 친구이기 때문이죠. 제 친구.",
    color: "from-stone-950 to-red-950",
    image: "/images/in-su-min.png",
    fallbackImage: "/images/인수민.png",
    imagePosition: "center 18%",
  },
  {
    name: "전세영",
    role: "배우",
    character: "나지라 / 압데사마드",
    quote: "읽고 쓰고 셈하고 말하는 법을 배워",
    color: "from-zinc-950 to-orange-950",
    image: "/images/jeon-se-young.jpg",
    fallbackImage: "/images/전세영.jpg",
    imagePosition: "center 18%",
  },
  {
    name: "정은상",
    ...
    character: "와합 / 수위 / 남자",
    quote: "우린 늘 함께 있을거야",
    color: "from-neutral-950 to-rose-950",
    image: "/images/jeong-eun-sang.png",
    fallbackImage: "/images/정은상.png",
    imagePosition: "center 18%",
  },
  {
    name: "최서원",
    role: "배우",
    character: "중년 나왈",
    quote: "그 고통은 내 안에 독처럼 스며있어",
    color: "from-stone-900 to-red-950",
    image: "/images/choi-seo-won.jpg",
    fallbackImage: "/images/최서원.jpg",
    imagePosition: "center 18%",
  },
  {
    name: "최소진",
    role: "배우",
    character: "잔느",
    quote: "엄마의 침묵 속에는 무언가가 있어. 난 그걸 이해하고 싶어.",
    color: "from-zinc-900 to-amber-950",
    image: "/images/choi-so-jin.jpg",
    fallbackImage: "/images/최소진(1).jpg",
    imagePosition: "center 18%",
  },
];
...
const staff = [
  {
    name: "임지우",
    role: "기획",
    quote: "화염을 보러 와주신 관객 여러분 감사합니다.",
    image: "/images/im-ji-woo.png",
    fallbackImage: "/images/임지우.png",
    imagePosition: "center 18%",
  },
  {
    name: "박주희",
  ...
  },
  {
    name: "민채원",
    role: "조명",
    quote: "무대 위 작은 불빛들이 여러분의 마음 속에 불꽃처럼 오래 남길 바랍니다",
    image: "/images/min-chae-won.png",
    fallbackImage: "/images/민채원.png",
    imagePosition: "center 18%",
  },
  {
    name: "이수민",
    role: "음향",
    quote: "가장 뜨겁게 타오르는 순간을 들려드리겠습니다",
    image: "/images/lee-su-min-staff.jpg",
    fallbackImage: "/images/이수민(1).jpg",
    imagePosition: "center 18%",
  },
];
...
function runDataChecks() {
  ...
  console.assert(rehearsalPhotos.length === 9, `연습 사진 데이터는 9장이어야 합니다. 현재 ${rehearsalPhotos.length}장입니다.`);
  console.assert(actors.every((person) => person.name && person.role && person.character && person.quote), "모든 배우에게 name, role, character, quote가 있어야 합니다.");
  console.assert(staff.every((person) => person.name && person.role && person.quote), "모든 스텝에게 name, role, quote가 있어야 합니다.");
  console.assert(actors.every((person) => person.character === person.character.trim()), "배역 문자열 앞뒤에는 불필요한 공백이 없어야 합니다.");
  console.assert(RESERVATION_URL.startsWith("https://"), "예약 링크는 https 주소여야 합니다.");
}
...
function FallbackInitial({ name, className = "text-white/80", sizeClass = "text-7xl" }) {
  return <span className={`${sizeClass} font-black ${className}`}>{getInitials(name)}</span>;
}
...
function ProfileInitial({ name, image, fallbackImage, imagePosition = DEFAULT_IMAGE_POSITION }) {
  ...
  return (
    <div
      className={`${profileIconClass} bg-black/20`}
      style={{
        width: `${PROFILE_ICON_SIZE}px`,
        height: `${PROFILE_ICON_SIZE}px`,
        minWidth: `${PROFILE_ICON_SIZE}px`,
        minHeight: `${PROFILE_ICON_SIZE}px`,
        maxWidth: `${PROFILE_ICON_SIZE}px`,
        maxHeight: `${PROFILE_ICON_SIZE}px`,
        flexBasis: `${PROFILE_ICON_SIZE}px`,
        fontSize: PROFILE_ICON_FONT_SIZE,
    ...
    >
      {shouldShowImage ? (
        ...
        <FallbackInitial name={name} sizeClass="text-[30px]" className="text-stone-100" />
      )}
    </div>
  );
}
...
function PersonCard({ person, type, onClick }) {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      className="group relative flex h-full w-full flex-col overflow-hidden rounded-[1.4rem] border border-white/10 bg-white/[0.06] p-2.5 text-left shadow-2xl shadow-black/20 backdrop-blur transition hover:border-red-300/30 hover:bg-white/[0.08]"
      style={{ minHeight: `${CARD_MIN_HEIGHT}px` }}
    >
      <div
        className={`relative mb-2 flex w-full shrink-0 items-center justify-center overflow-hidden rounded-[1.1rem] bg-gradient-to-br ${person.color || "from-stone-900 to-red-950"}`}
        style={{ height: `${CARD_MEDIA_HEIGHT}px` }}
      >
        ...
        <div className="absolute bottom-2 left-2 right-2 z-20 flex items-center justify-between gap-1.5">
          <span className="inline-flex h-6 min-w-[48px] items-center justify-center rounded-full bg-white/12 px-2 text-[10px] font-bold text-stone-100 backdrop-blur">
            {type}
          </span>
          <span className="inline-flex h-6 min-w-[54px] items-center justify-center rounded-full bg-red-500/20 px-2 text-[10px] font-bold text-red-100 backdrop-blur">
            Profile
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-1 flex-col space-y-1" style={{ minHeight: `${CARD_BODY_MIN_HEIGHT}px` }}>
        ...
        {isActor && (
          <p className="line-clamp-1 text-[11px] leading-4 text-stone-300">
            {person.character}
          </p>
        )}
      </div>

      <div className="pointer-events-none absolute inset-0 rounded-[1.4rem] ring-1 ring-inset ring-white/0 transition group-hover:ring-red-300/40" />
    </motion.button>
  );
}
    ...
    <div className={`relative h-[430px] overflow-hidden bg-gradient-to-br ${selected.color || "from-stone-900 to-red-950"}`}>
      {shouldShowImage ? (
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-[radial-gradient(circle_at_30%_20%,rgba(255,255,255,0.22),transparent_30%),radial-gradient(circle_at_70%_70%,rgba(239,68,68,0.32),transparent_35%)]">
          <FallbackInitial name={selected.name} />
        </div>
      )}
...
function ProfileModal({ selected, onClose }) {
  return (
    <AnimatePresence>
      {selected && (
        <motion.div
          className="fixed inset-0 z-50 flex items-end justify-center bg-black/70 p-3 backdrop-blur-sm"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          onClick={onClose}
        >
          <motion.div
            ...
            transition={{ type: "spring", stiffness: 260, damping: 24 }}
            onClick={(event) => event.stopPropagation()}
            className="relative grid max-h-[92vh] w-full max-w-[430px] overflow-y-auto rounded-3xl border border-white/10 bg-[#120d0b] shadow-2xl"
          >
            <button
              type="button"
              onClick={onClose}
            ...
            <div className="space-y-6 p-7">
              ...
              <blockquote className="rounded-2xl border border-red-300/15 bg-red-500/10 p-5 text-base leading-8 text-red-50">
                “{selected.quote}”
              </blockquote>
            </div>
          </motion.div>
...
export default function PerformanceProfilePromoSite() {
  ...
  const filteredActors = useMemo(() => {
    return actors.filter((person) => `${person.name} ${person.role} ${person.character} ${person.quote}`.toLowerCase().includes(normalizedQuery));
  }, [normalizedQuery]);

  const filteredStaff = useMemo(() => {
    return staff.filter((person) => `${person.name} ${person.role} ${person.quote}`.toLowerCase().includes(normalizedQuery));
  }, [normalizedQuery]);
  ...
  return (
    <main className="mx-auto min-h-screen w-full max-w-[430px] overflow-hidden bg-[#0b0807] text-stone-100 shadow-2xl shadow-black/40">
      <section className="relative isolate px-5 py-8">
        ...
        <nav className="mx-auto flex max-w-7xl flex-col gap-4 rounded-[2rem] border border-white/10 bg-white/[0.05] px-5 py-4 backdrop-blur">
          ...
          <div className="grid w-full grid-cols-3 gap-2">
            <a href={RESERVATION_URL} target="_blank" rel="noreferrer" className="inline-flex h-11 items-center justify-center whitespace-nowrap rounded-full bg-red-500 px-3 text-xs font-black text-white transition hover:bg-red-400">
              예약하기
            </a>
            <a href="#rehearsal" className="inline-flex h-11 items-center justify-center whitespace-nowrap rounded-full border border-white/10 bg-white/[0.06] px-3 text-xs font-black text-white transition hover:bg-white/10">
              연습 사진
            </a>
            <a href="#profiles" className="inline-flex h-11 items-center justify-center whitespace-nowrap rounded-full bg-white px-3 text-xs font-black text-stone-950 transition hover:bg-red-100">
              프로필 보기
            </a>
          </div>
        </nav>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 pb-14 pt-14">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="space-y-8">
            ...
            <div className="space-y-5">
              <h1 className="max-w-4xl text-4xl font-black leading-[1.05] tracking-[-0.05em] text-white">
                수원여자대학교<br />
                <span className="bg-gradient-to-r from-red-200 via-orange-200 to-stone-100 bg-clip-text text-transparent">연기영상과</span>
              </h1>
              <p className="max-w-2xl text-base leading-7 text-stone-300">
                공연을 만든 배우와 스텝을 담았습니다.<br />
                프로필 카드를 눌러 확인해보세요.
              </p>
            </div>
            <div className="flex flex-col gap-3">
              ...
              <a href={RESERVATION_URL} target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 rounded-full border border-white/15 bg-white/[0.06] px-7 py-4 text-base font-bold text-white backdrop-blur transition hover:bg-white/10">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, delay: 0.1 }} className="relative">
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.06] p-4 shadow-2xl shadow-black/40 backdrop-blur">
              <div className="min-h-[420px] overflow-hidden rounded-[1.5rem] bg-[radial-gradient(circle_at_40%_20%,rgba(254,202,202,0.24),transparent_28%),linear-gradient(135deg,#2b0b08,#090605_55%,#581c1c)] p-6">
                <div className="flex h-full flex-col justify-between">
                  ...
                  <div className="space-y-4">
                    ...
                    <h2 className="text-5xl font-black tracking-[-0.06em] text-white">화염</h2>
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-3 pb-1">
                    {["14 Actors", "6 Staff"].map((item) => (
                      <div key={item} className="min-w-0 rounded-2xl border border-white/10 bg-black/25 px-4 py-3 text-center text-sm font-bold leading-none text-stone-100">
                        {item}
                      </div>
                    ))}
                  </div>
      ...
      <section id="info" className="border-y border-white/10 bg-white/[0.03] px-5 py-8">
        <div className="mx-auto grid max-w-7xl gap-4">
          <div className="rounded-3xl border border-white/10 bg-black/20 p-6">
            <CalendarDays className="mb-4 text-red-200" />
            <p className="text-xs font-bold uppercase tracking-[0.22em] text-red-200/80">공연 일시</p>
            <div className="mt-3 space-y-1.5 text-white">
              <p className="text-lg font-black leading-6">5월 29일</p>
              <p className="text-sm leading-6 text-stone-300">19:00</p>
              <p className="pt-2 text-lg font-black leading-6">5월 30일</p>
              <p className="text-sm leading-6 text-stone-300">14:00 · 18:00</p>
            </div>
          </div>
          <div className="rounded-3xl border border-white/10 bg-black/20 p-6">
            <MapPin className="mb-4 text-red-200" />
            <p className="text-xs font-bold uppercase tracking-[0.22em] text-red-200/80">공연 장소</p>
          ...
          <div className="rounded-3xl border border-white/10 bg-black/20 p-6">
            ...
            <p className="text-xs font-bold uppercase tracking-[0.22em] text-red-200/80">예매 / 문의</p>
            <a
      ...
      <section id="rehearsal" className="px-5 py-16">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 grid gap-5">
            ...
            <p className="max-w-2xl text-sm leading-7 text-stone-400">
              공연이 완성되기 전,<br />
              배우와 스텝이 함께 쌓아온 시간을 담았습니다.<br />
              무대 뒤의 과정까지 함께 느껴보세요.
            </p>
          </div>

          <div className="grid gap-5">
            <RehearsalImageCard photo={rehearsalPhotos[0]} index={0} onClick={setSelectedRehearsal} />

            <div className="grid grid-cols-2 gap-3">
              {rehearsalPhotos.slice(1).map((photo, index) => (
                <RehearsalImageCard key={photo.title} photo={photo} index={index} onClick={setSelectedRehearsal} />
              ))}
            </div>
          </div>
        </div>
      ...
      <section id="profiles" className="px-5 py-16">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 flex flex-col justify-between gap-6">
            <div className="space-y-4">
              ...
              <p className="max-w-2xl text-base leading-7 text-stone-400">
                이름을 검색하거나 카드를 눌러<br />역할과 한 줄 문장을 확인할 수 있습니다.
              </p>
            </div>
            <div className="flex w-full flex-col gap-3">
              ...
              <div className="grid grid-cols-2 gap-2 rounded-full border border-white/10 bg-white/[0.04] p-1">
                <button type="button" onClick={() => setTab("actors")} className={`rounded-full px-5 py-3 text-sm font-bold transition ${tab === "actors" ? "bg-white text-stone-950" : "text-stone-300 hover:bg-white/10"}`}>
                  배우 14명
                </button>
                <button type="button" onClick={() => setTab("staff")} className={`rounded-full px-5 py-3 text-sm font-bold transition ${tab === "staff" ? "bg-white text-stone-950" : "text-stone-300 hover:bg-white/10"}`}>
                  스텝 6명
                </button>
              </div>
            </div>
      ...
      <footer className="border-t border-white/10 px-5 py-10 text-center text-xs leading-6 text-stone-500">
        <p>© 2026 INCENDIES Profile Archive.</p>
        <p>저희 공연을 보러 와주셔서 감사합니다.</p>
      </footer>
